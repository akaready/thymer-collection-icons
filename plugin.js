...
[description truncated \u2014 URL length limit]`;
  ...
  var Plugin = class extends AppPlugin {
     ...
     * config until edited here; edits auto-flush to this device's synced slot,
     * while "Apply to all devices" promotes the shared baseline.
    ...
    onLoad() {
      ...
      void healPluginIdentity(this, {
        ...
        icon: "link",
        description: "Replace Thymer's inline-link arrow with each collection's or page's icon.",
        sourceRepo: "https://github.com/akaready/thymer-collection-icons",
     ...
     * synced values auto-reconverges). The store auto-flushes that device slot;
     * the explicit header push alone promotes it to every device. Call sites
     * mutate `this._settings` first, then call this.
     */
    _saveSettings() {
